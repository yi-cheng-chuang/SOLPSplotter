...
class integrate_flux:
    ...
    def allcover_three(self):
        ...
        axs[0].axvline(x=arclength[0], color='steelblue', linestyle='--')
        axs[0].axvline(x=arclength[-1], color='darkolivegreen', linestyle='--')
        axs[0].axvline(x=arclength[23], color='black', linestyle='--')
        axs[0].axvline(x=arclength[71], color='black', linestyle='--')
        axs[1].axvline(x=arclength[0], color='steelblue', linestyle='--',
                       label='outer target')
        axs[1].axvline(x=arclength[-1], color='darkolivegreen', linestyle='--',
                       label='inner target')
