# -*- coding: utf-8 -*-
"""
Created on Tue Nov 11 23:39:05 2025
...
class series_2para_polplot:
    ...
    def series_2para_method(self, iterlist, cl_dic, plot_section, parameter, ang_list, pol_list, rad_loc):
    ...
    def sr2para_polplot(self, pol_list, parameter, rad_loc):
        ...
        if withshift == False and withseries == True:
            ...
            self.series_2para_method(iterlist=labels, cl_dic=color_map, ang_list=ang_list, rad_loc=rad_loc,
