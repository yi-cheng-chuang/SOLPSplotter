...
class load_ftfiles_data:
    ...
    def one_dim_scan_ft46(self, iterlist):
        ...
        for aa in iterlist:
            ...
            file_loc = '{}/{}'.format(self.data['dirdata']
                                      ['simudir'][aa], 'fort.46.i')
