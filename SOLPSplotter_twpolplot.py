...
class tw_polplot(NT_plot):
    ...
    def twtripp_method(self, iterlist, cl_dic, scan_style, plot_option, ang_list, pol_list, log_flag):
    ...
    def twtripp(self, scan_style, pol_list, log_flag):
        ...
        if self.withshift == False and self.withseries == True:
            ...
            if self.series_flag == 'twin_scan':
                ...
                for ta in keylist_a:
                    ...
                    self.twtripp_method(iterlist = iter_key, cl_dic = color_dic, 
                                scan_style = scan_style, ang_list = ang_list, 
