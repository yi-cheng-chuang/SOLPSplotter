...
class directory_input:
    ...
    def mast_comp_dic(self):
        a_shift = 'org'
        shift_dic = {'org': 0, 'dot3': 0.3, 'dot5': 0.5,
                     'dot55': 0.55, 'dot7': 0.7, 'one': 1}
    ...
    def mast_comp_dic_withshift(self):
        ...
        if bc == 'fixed':
            ...
            shift_dic = {'org': 0, 'dot3': 0.3,
                         'dot5': 0.5, 'dot55': 0.55, 'dot7': 0.7}
    ...
    def mastcomp_withshift_compare(self):
        ...
        shift_dic = {'org': 0, 'dot3': 0.3, 'dot5': 0.5, 'dot7': 0.7}
        shift = ['org_cfluxb_std', 'dot3', 'dot5', 'dot7']
        tail = {'org': 'nts_a', 'dot3': 'dot3_a',
                'dot5': 'dot5_a', 'dot7': 'dot7_a'}
    ...
    def terminal_series_comp_dir(self):
        ...
        ds_list, ts_list = self.scan_list(
            denscan_dic=ds_dic, tempscan_dic=ts_dic)
