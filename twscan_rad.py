...
from twscan_correlate import twcorrelate
...
class twsc_rad(twcorrelate):
    
    def __init__(self, DefaultSettings, loadDS):
        twcorrelate.__init__(self, DefaultSettings, loadDS)
    
    
    
    def scan_rad(self, dat_size, scan_var, format_option, pol_loc, plot_case, scan_style, log_scale):
