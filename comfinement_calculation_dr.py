# -*- coding: utf-8 -*-
"""
Created on Mon Jan 12 01:19:42 2026
...
from comfinement_and_flux.comfinement_calculator import comfinement_calculation


class comfinement_demo_datapipline:
    ...
    def comfinement_demo(self):
        ...
        xcc = comfinement_calculation(DF=self.DF, data=self.data)
        ...
        if self.DF.DEV == 'mast':
            ...
            if withshift == False and withseries == False:
                ...
                xcc.particle_balance()


if __name__ == "__main__":
    dpl = comfinement_demo_datapipline()
    dpl.comfinement_demo()
