# -*- coding: utf-8 -*-
"""
Created on Tue Apr  1 22:29:24 2025

@author: ychuang
"""

import SOLPS_set as sps
import twscan_correlate as tc
...
xl = tc.twcorrelate(DefaultSettings = d, loadDS = lex)
...
xl.twscan_corr(dat_size = 'small', scan_var = 'ne_sep', format_option = 'opaqueness', 
             pol_list = poloidal_index_list, plot_case = 'fivescan', scan_style = 'density')
