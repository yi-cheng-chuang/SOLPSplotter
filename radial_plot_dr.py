            ...
            if withshift == False and withseries == False:
                ...
                if dat_type == 'midplane scans':
                    ...
                    if midprof == 'NT':
                        ...
                        xnt.neteTS_plot(scan_style='tempscan',
                                        xcoord_type='psi')
                        ...
                        xsm.srmidS_plot(xcoord_type='rrsep')
                    ...
                    xstr.series_targetNT(log_flag=True, match=True)

                    # xttr.twinscan_targetNT(
                    #     scan_style='denscan', log_flag=True, match=True)
