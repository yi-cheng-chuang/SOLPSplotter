        ...
        if self.DF.DEV == 'cross_machine':
            ...
            if self.DF.Dnames == 'mastu_mast':
                ...
                if self.DF.terminal == False:
                    ...
                    self.data['mastu_dircomp'] = self.di.mastu_comp_dic()
                    mastu_basedir, Attempt_dic = self.ldm.mastu_base_dir()
                    self.data['mastu_dirdata'] = mastu_basedir
                    self.data['mastu_dircomp']['Attempt'] = Attempt_dic

                    self.data['mast_dircomp'] = self.di.mast_comp_dic()
                    ...
                    self.data['mast_dircomp']['shift'] = shift_value
            ...
            if self.DF.withshift == False and self.DF.withseries == False:
                ...
                if flux_std:
                    ...
                    if terminal == False:
                        ...
                        print(
                            'terminal option for flux std needs to be updated, we left it for future user')
                ...
                if series_flag == 'ionCX_scan':
                    self.data['dircomp'] = self.di.mast_comp_dir_ionCXscan()
                    ...
                    if terminal == True:
                        ...
                        series_dir, att_dic = self.ldm.series_terminal_dir(
                        ...
                        series_dir, att_dic = self.ldm.twinscan_local_dir(
                            dir_comp_dic=dir_comp)
