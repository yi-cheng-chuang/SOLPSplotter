# -*- coding: utf-8 -*-
"""
Created on Thu Apr  3 11:18:34 2025

@author: ychuang
"""

import SOLPS_set as sps
import twscan_polpare as tp
...
xl = tp.twscan_polcompare(DefaultSettings = d, loadDS = lex)
...
xl.twscan_pol(dat_size = 'small', scan_var = 'ne_sep', format_option = 'neuden', 
             pol_list = poloidal_index_list, plot_case = 'single', scan_style = 'density', logscale = True)
