# -*- coding: utf-8 -*-
"""
Created on Tue Apr  1 21:44:32 2025
...
import twscan_contour_plot as tcp
...
xl = tcp.twscan_contour(DefaultSettings = d, loadDS = lex)
...
xl.twscan_contour_plot(dat_size = 'small', scan_style = 'denscan')